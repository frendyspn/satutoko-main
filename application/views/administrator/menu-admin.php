          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <?php
                ...
                $cek=$this->model_app->umenu_akses("notifikasi",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/notifikasi'><i class='fa fa-circle-o'></i> Notifikasi</a></li>";
                }
              ?>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <?php 
                  ...
                  $cek=$this->model_app->umenu_akses("ppob",$this->session->id_session);
                  if($cek==1 OR $this->session->level=='admin'){
                    echo "<li><a href='".base_url().$this->uri->segment(1)."/ppob'><i class='fa fa-circle-o'></i> PPOB</a></li>";
                  }
                  ...
                  $cek=$this->model_app->umenu_akses("imagesslider",$this->session->id_session);
                  if($cek==1 OR $this->session->level=='admin'){
                    echo "<li><a href='".base_url().$this->uri->segment(1)."/link_batrisyia'><i class='fa fa-circle-o'></i> Link Batrisyia.id</a></li>";
                  }
                ?>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <?php 
                  ...
                  if($cek==1 OR $this->session->level=='admin'){
                    echo "<li><a href='".base_url().$this->uri->segment(1)."/reseller'><i class='fa fa-circle-o'></i> Toko / Pelapak</a></li>";
                  }

                  $cek=$this->model_app->umenu_akses("sopir",$this->session->id_session);
                  if($cek==1 OR $this->session->level=='admin'){
                    echo "<li><a href='".base_url().$this->uri->segment(1)."/sopir'><i class='fa fa-circle-o'></i> Kurir Internal</a></li>";
                  }
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <?php 
                  ...
                  if($cek==1 OR $this->session->level=='admin'){
                    echo "<li><a href='".base_url().$this->uri->segment(1)."/penjualan'><i class='fa fa-circle-o'></i> Penjualan ke Pelapak</a></li>";
                  }

                  $cek=$this->model_app->umenu_akses("pembayaran_reseller",$this->session->id_session);
                  if($cek==1 OR $this->session->level=='admin'){
                    echo "<li><a href='".base_url().$this->uri->segment(1)."/pembayaran_reseller'><i class='fa fa-circle-o'></i> Pembayaran Pelapak</a></li>";
                  }
                  ...
                  if($cek==1 OR $this->session->level=='admin'){
                    echo "<li><a href='".base_url().$this->uri->segment(1)."/reseller_paket'><i class='fa fa-circle-o'></i> Trans. Paket Pelapak</a></li>";
                  }
