                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<input type='hidden' name='id' value='$row[id_logo]'>
                          <tr><th width=140px>Logo Terpasang</th><td><img width='30%' src='".base_url()."asset/logo/$row[gambar]'></td></tr>";
                      $no++;
                    }
                    echo "<tr><th>Ganti Logo</th><td><input type='file' name='logo' class='form-control'></td></tr>
