                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    foreach ($record->result_array() as $row){
                      // $this->db->query("DELETE FROM `rb_penjualan_detail` where id_penjualan='$row[id_penjualan]'");
                      // $this->db->query("DELETE FROM `rb_penjualan_otomatis` where kode_transaksi='$row[kode_transaksi]'");
                      ...
                      echo "<tr><td>$no</td>
                              <td>$kode_transaksi ".($row['id_penjual']=='0'?"<small class='label bg-green'>Mall</small>":'')."</td>
                              ...
                              if ($row['kode_kurir']=='1'){
                                ...
                                if (jenis_produk($row['id_penjualan'])=='Digital'){
                                  echo "<td style='color:#cecece'>Produk Digital</td>";
                                }else{
