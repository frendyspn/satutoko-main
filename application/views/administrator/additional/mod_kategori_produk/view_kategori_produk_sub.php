              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    if ($row['id_parent']!='0'){
                      $data = $this->db->query("SELECT * FROM rb_kategori_produk_sub where id_kategori_produk_sub='$row[id_parent]'")->row_array();
                      $parent = "<span style='color:blue'>".$data['nama_kategori_sub']."</span> <i class='fa fa-arrow-right'></i> ";
                    }else{
                      $parent = '';
                    }
                    echo "<tr><td>$no</td>
                              <td style='color:green'><b>$row[nama_kategori]</b></td>
                              <td>$parent $row[nama_kategori_sub]</td>
                              <td>$row[icon_kode]</td>
