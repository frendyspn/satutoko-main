                                ...
                                if ($row['transaksi']=='debit'){ 
                                  if (substr($row['keterangan_order'],-1)=='%'){
                                    ...
                                    if ($expp['0']=='Komisi'){
                                      ...
                                      echo "<td><span style='color:red'>Bayar Komisi</span> $row[keterangan_order]</td>";
                                    }
                                  }else{
                                    $expp = explode(' ',$row['keterangan_order']);
                                    if ($expp['1']=='Dipotong'){
                                  ...
                                  if (substr($row['keterangan_order'],-1)=='%'){
                                    ...
                                    if ($expp['0']=='Komisi'){
                                      ...
                                      echo "<td><span style='color:green'>Terima Komisi</span> $row[keterangan_order]</td>";
                                    }
                                  }else{
                                    echo "<td>Deposit via Payment Gateway</td>"; 
                                  }
                                }
                              
                              }else{
                                if ($row['transaksi']=='debit'){
                                  echo "<td><b style='color:orange'>Withdraw</b> - $ex[0], $ex[1], $ex[2]</td>";
                                }else{
                                  $rek = $this->model_app->view_where('rb_rekening',array('id_rekening'=>$row['id_rekening_reseller']))->row_array();
                                  echo "<td><b style='color:blue'>Deposit</b> - $rek[nama_bank], $rek[no_rekening], $rek[pemilik_rekening]</td>";
                                }
                              }
