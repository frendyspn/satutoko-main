    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='140px' scope='row'>Users</th>    <td><select id='id_reseller' class='form-control combobox' name='id_reseller' required>
                                                                                <option value=''>- Pilih/Tulis Nama Konsumen atau Reseller -</option>";
                    ...
                    $jenis = array('debit','kredit','debitx');
                    $jenis_text = array('Debit (Withdraw)','Kredit (Deposit)','Potong Saldo');
                    for ($i=0; $i < count($jenis); $i++) { 
                      echo "<option value='$jenis[$i]'>$jenis_text[$i]</option>";
                    }
                  echo "</select></td></tr>
                    <tr class='bagikan' style='display:none'><th scope='row'>Bagikan</th>    <td><select name='bagikan' class='form-control form-mini'>";
                      $jenisx = array('ya','tidak');
                      $jenis_textx = array('Ya','Tidak');
                      for ($i=0; $i < count($jenisx); $i++) { 
                        echo "<option value='$jenisx[$i]'>$jenis_textx[$i]</option>";
                      }
                    echo "</select></td></tr>

                    <tr class='rekening'  style='display:none'><th scope='row'>Rekening Tujuan</th>    <td><select name='a' class='form-control form-mini' id='rekening'>
                    <option value='' selected>- Pilih -</option>
                  </select></td></tr>
                    </tbody>
                  </table>
