    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <input type='text' id='jenis_paket' name='jenis_paket' value='' required>
                    <tr><th scope='row'>Jenis paket</th>               <td><input type='radio' name='jenis' value='toko'> Toko &nbsp; <input type='radio' name='jenis' value='konsumen'> Konsumen</td></tr>
                    ...
                    <tr class='jenis'><th width='120px' scope='row'>Max Produk</th>    <td><input type='number' class='form-control' name='max_produk' required></td></tr>
