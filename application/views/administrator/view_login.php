...
<html>
  <head>
    ...
    <style>.login-page, .register-page { background: #d5d5d5; } .login-box-body, .register-box-body { box-shadow: 0 0 1px rgb(0 0 0 / 13%), 0 1px 3px rgb(0 0 0 / 20%); }</style>
  </head>
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <p style="text-align: center; padding:15px"><a href='<?= base_url(); ?>'>Kembali ke Halaman utama</a></p>
    </div><!-- /.login-box -->
