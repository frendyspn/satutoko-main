                ...
                <div class="ps-layout__right">
                    ...
                    <?php echo $this->session->flashdata('message'); 
                        ...
                        <div class="ps-block__content">
                            <div class="owl-slider" id="bestsale" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="10" data-owl-nav="false" data-owl-dots="false" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="2" data-owl-item-lg="3" data-owl-item-xl="4" data-owl-duration="1000" data-owl-mousedrag="on">
                                <?php 
                                    ...
                                    foreach ($produk_terlaris->result_array() as $row){
                                        ...
                                        if ($disk['diskon']>=1){ 
                                            ...
                                            $harga_produk = getHargaJual($row['id_produk'],'','YES');
                                        }else{
                                            // $harga_produk =  "Rp ".rupiah($row['harga_konsumen']);
                                            $harga_produk = getHargaJual($row['id_produk']);
                                        }
