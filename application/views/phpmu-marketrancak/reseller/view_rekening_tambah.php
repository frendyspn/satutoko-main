                    ...
                    <figure class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Nama Bank</b></label>
                              <div class='col-sm-10'>
                                <select class='form-control form-mini' name='a' required>
                            ...
                            <button type='submit' name='submit' class='mt-3 ps-btn spinnerButton'><center><i class='icon-pen'></i> Simpan Rekening</center></button>";
                        ?>
                    </figure>
                </div>
                    </form>
