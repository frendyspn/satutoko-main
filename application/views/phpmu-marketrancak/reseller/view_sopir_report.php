            ...
            <div class="row">
                ...
                <div class='col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 biodata notif'>
                          ...
                          <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Alamat Jemput</b></label>
                            <div class='col-sm-10'>
                              <span>Pengirim : <b><a href='".base_url()."u/$row[user_reseller]'><span class='text-primary text-uppercase'>$row[nama_reseller]</span></a></b> (+".format_telpon($row['no_telpon']).")<br> $row[alamat_lengkap], ".kecamatan($row['kecamatan_id_jual'],$row['kota_id_jual'])."</span>
                            </div>
                          </div>
                          <div class='form-group row' style='margin-bottom:5px'>
