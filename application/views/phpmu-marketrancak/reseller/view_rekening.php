                    ...
                    <figure class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            if ($record->num_rows()<=0){
                                echo "<div class='alert alert-danger'><strong>PENTING</strong> - Halo kak! Data rekening bank-nya di isi ya. <br class='d-none d-sm-block'> Biar lebih enak transaksinya, yuk klik <a href='".base_url()."members/tambah_rekening_bank' style='color:#000'><b>disini</b></a>.</div>";
                            }
