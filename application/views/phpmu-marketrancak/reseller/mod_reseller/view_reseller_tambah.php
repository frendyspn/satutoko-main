        ...
        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 ">
            ...
            <?php 
              ...
              <label class='col-sm-3 col-form-label' style='margin-bottom:1px'>Tokopedia</b></label>
                <div class='col-sm-9'>
                  <input type='url' name='tokopedia' class='form-control form-mini' placeholder='https://'>
                </div>
              </div>
              ...
              <label class='col-sm-3 col-form-label' style='margin-bottom:1px'>Shoopee</b></label>
                <div class='col-sm-9'>
                  <input type='url' name='shoopee' class='form-control form-mini' placeholder='https://'>
                </div>
              </div>
