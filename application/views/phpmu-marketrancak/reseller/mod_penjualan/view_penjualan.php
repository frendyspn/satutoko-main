      ...
      <div class="ps-section__content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 penjualan"><br>
                ...
                <div class="scrollmenu">
                  <a href="<?= base_url(); ?>members/penjualan" class="nav-link <?php echo ($_GET['page'] == '' ? 'active' : ''); ?>">Menunggu Pembayaran <span class="badge badge-secondary"><?php echo total_penjualan_pending('0',reseller($this->session->id_konsumen)); ?></span></a>
                  <a href="<?= base_url(); ?>members/penjualan?page=siap" class="nav-link <?php echo ($_GET['page'] == 'siap' ? 'active' : ''); ?>">Lunas (Siap Dikirim) <span class="badge badge-secondary"><?php echo total_penjualan('1',reseller($this->session->id_konsumen)); ?></span></a>
                  <a href="<?= base_url(); ?>members/penjualan?page=dikirim" class="nav-link <?php echo ($_GET['page'] == 'dikirim' ? 'active' : ''); ?>">Sedang Dikirim <span class="badge badge-secondary"><?php echo total_penjualan('3',reseller($this->session->id_konsumen)); ?></span></a>
                  <a href="<?= base_url(); ?>members/penjualan?page=selesai" class="nav-link <?php echo ($_GET['page'] == 'selesai' ? 'active' : ''); ?>">Sampai Tujuan <span class="badge badge-secondary"><?php echo total_penjualan('4',reseller($this->session->id_konsumen)); ?></span></a>
                  <a href="<?= base_url(); ?>members/penjualan?page=batal" class="nav-link <?php echo ($_GET['page'] == 'batal' ? 'active' : ''); ?>">Batal / Ditolak <span class="badge badge-secondary"><?php echo total_penjualan('x',reseller($this->session->id_konsumen)); ?></span></a>
                </div>
