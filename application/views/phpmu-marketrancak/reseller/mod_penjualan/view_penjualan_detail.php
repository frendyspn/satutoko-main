            ...
            <div class='table-responsive'>
                <table class="table table-sm iconset">
                  ...
                  <?php 
                    ...
                    echo "<a style='font-size:17px; display:block; border-bottom:1px dotted' href='".base_url()."produk/detail/$row[produk_seo]'>$row[nama_produk] $nama_level</a>
                  ...
                  <?php 
                    if ($cekk['jenis_produk']=='Digital'){
                      if ($rows['proses']==1 OR $rows['proses']==3){
              ...
              <?php 
                if($rows['kode_kurir']!='0' AND $rows['kode_kurir']!='-'){ // Jika Transaksi Bukan COD 
              ?>
                  ...
                  <table class="table table-sm table-condensed iconset">
                    ...
                    ?>
                      ...
                      <tr><th scope='row'><b>Input No. Resi</b></th>        <td>
                        ...
                        <input style='color:red; width:75%; display:inline-block' type='text' value='<?php echo "$rows[no_resi]"; ?>' class='form-control form-mini' name='no_resi' placeholder='- - - - - - - - -' autocomplete='off' required>
                        <button class='ps-btn margin-btn' style='padding:6px 15px !important; margin-top:3px' type='submit' name='submit'><span class='fa fa-check'></span> Submit</button><br>
                        <small><b>PENTING</b> - Status Order akan jadi "<span class='text-success'>Dikirim</span>" jika Resi diinput.</small>
                        </form>
                      </td></tr>
