                ...
                <button class="flip ps-btn--outline ps-btn--fullwidth d-block d-sm-none" style='margin-bottom:10px'>Filter Produk</button>
                    ...
                    <div class="ps-shopping ps-tab-root">
                        <div class="ps-shopping__header">
                            <p>Terdapat <strong><?php echo $record->num_rows(); ?></strong> Produknya</p>
                                ...
                                <div class="ps-shopping-product">
                                    ...
                                    <?php 
                                        foreach ($record->result_array() as $row){
                                            ...
                                            echo "<div class='col-xl-3 col-lg-3 col-md-3 col-sm-$kolom col-$kolom '>
                                                    <div class='ps-product'>
                                                        ...
                                                        <div class='ps-product__container'>
                                                            ...
                                                            <a class='ps-product__vendor' href='".base_url()."".user_reseller($row['id_reseller'])."'>".cek_paket_icon($row['id_reseller'])." $row[nama_reseller]</a>
                                                                ...
                                                                <small class='text-primary'>".textRekomenJual().$harga_produk."</small>
                                                            </div>
