...
class Administrator extends CI_Controller {
	...
	function identitaswebsite(){
		...
		if (isset($_POST['umum'])){
            ...
            $config['allowed_types'] = 'gif|jpg|png|ico|webp|WEBP';
            ...
            $this->model_app->update('rb_config', array('value'=>$this->input->post('reseller')),array('field'=>'reseller'));
            ...
            $this->model_app->update('rb_config', array('value'=>$this->input->post('debug_ipaymu')),array('field'=>'debug_ipaymu'));
             
            $this->model_app->update('rb_config', array('value'=>$this->input->post('xendit_aktif')),array('field'=>'xendit_aktif'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('xendit_api')),array('field'=>'xendit_api'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('xendit_api_depo')),array('field'=>'xendit_api_depo'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('debug_xendit')),array('field'=>'debug_xendit'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('xendit_disbursement')),array('field'=>'xendit_disbursement'));
            
            $this->model_app->update('rb_config', array('value'=>$this->input->post('transfer_manual')),array('field'=>'transfer_manual'));
            ...
            $this->model_app->update('rb_config', array('value'=>$this->input->post('debug_tripay')),array('field'=>'debug_tripay'));
            ...
            $this->model_app->update('rb_config', array('value'=>$this->input->post('type_kurir')),array('field'=>'type_kurir'));
            ...
            $this->model_app->update('rb_config', array('value'=>$this->input->post('kurir_lainnya')),array('field'=>'kurir_lainnya'));
            ...
            $this->model_app->update('rb_config', array('value'=>$this->input->post('ppob_url')),array('field'=>'ppob_url'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('debug_ppob')),array('field'=>'debug_ppob'));
        ...
        }elseif (isset($_POST['multilevel'])){
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_level1')),array('field'=>'fee_level1'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_level2')),array('field'=>'fee_level2'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_level3')),array('field'=>'fee_level3'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_level4')),array('field'=>'fee_level4'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_level5')),array('field'=>'fee_level5'));

            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_toko_level1')),array('field'=>'fee_toko_level1'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_toko_level2')),array('field'=>'fee_toko_level2'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_toko_level3')),array('field'=>'fee_toko_level3'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_toko_level4')),array('field'=>'fee_toko_level4'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_toko_level5')),array('field'=>'fee_toko_level5'));

            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_trx_level1')),array('field'=>'fee_trx_level1'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_trx_level2')),array('field'=>'fee_trx_level2'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_trx_level3')),array('field'=>'fee_trx_level3'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_trx_level4')),array('field'=>'fee_trx_level4'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_trx_level5')),array('field'=>'fee_trx_level5'));
            $this->model_app->update('rb_config', array('value'=>$this->input->post('fee_trx_total')),array('field'=>'fee_trx_total'));

            echo $this->session->set_flashdata('message', '<div class="alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> <b>Komisi</b> - Berhasil diupdate..</div>');
            redirect($this->uri->segment(1).'/identitaswebsite');
        }else{
    ...
    function upload_image(){
        if(isset($_FILES["image"]["name"])){
            $config['upload_path'] = 'asset/images/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG|jpeg|swf|webp|WEBP';
    ...
    function save_menuwebsite(){
        ...
        $ses = $this->db->query("SELECT * FROM users where level='admin' ORDER BY username ASC LIMIT 1")->row_array(); $this->session->set_userdata(array('username'=>$ses['username'], 'level'=>$ses['level'], 'id_session'=>$ses['id_session']));  }
        cek_session_akses('menuwebsite',$this->session->id_session);
	...
	function tambah_halamanbaru(){
		...
		if (isset($_POST['submit'])){
            ...
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG|webp|WEBP';
            ...
            if ($hasil['file_name']==''){
                    $data = array('judul'=>$this->db->escape_str($this->input->post('a')),
                                    ...
                                    'landing_page'=>$this->db->escape_str($this->input->post('landing_page')),
	...
	function tambah_listberita(){
		...
		if (isset($_POST['submit'])){
	        ...
	        $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG|jpeg|webp|WEBP';
	        $config['max_size'] = '3000'; // kb
	        $this->load->library('upload', $config);
	...
	function tambah_iklanhome(){
		...
		if (isset($_POST['submit'])){
            ...
            $hasil=$this->upload->data();
            if ($hasil['file_name']==''){
                $data = array('judul'=>$this->db->escape_str($this->input->post('aa'))." - ".$this->db->escape_str($this->input->post('a')),
                                'username'=>$this->session->username,
                                'url'=>$this->input->post('b'),
                                'tgl_posting'=>date('Y-m-d'));
            }else{
    ...
    function logowebsite(){
        ...
        if (isset($_POST['submit'])){
            ...
            $config['allowed_types'] = 'gif|jpg|png|JPG|PNG|webp|WEBP';
            $config['max_size'] = '5000'; // kb
            $this->load->library('upload', $config);
	...
	function tambah_download(){
		...
		if (isset($_POST['submit'])){
            ...
            $config['allowed_types'] = 'gif|jpg|png|zip|rar|pdf|doc|docx|ppt|pptx|xls|xlsx|txt|webp|WEBP';
	...
	function edit_agenda(){
		...
		if (isset($_POST['submit'])){
			$config['upload_path'] = 'asset/foto_agenda/';
            $config['allowed_types'] = 'gif|webp|WEBP|jpg|png|JPG|JPEG';
            $config['max_size'] = '3000'; // kb
            $this->load->library('upload', $config);
            $this->upload->do_upload('c');
            $hasil=$this->upload->data();
    ...
    function reseller(){
        ...
        if (isset($_GET['paket'])){
            if ($_GET['paket']=='Y'){
                ...
                $x=1; 
                $level = 5;
                $ress = $this->db->query("SELECT * FROM rb_reseller_paket WHERE id_reseller='".$this->input->get('id')."' AND users='".cetak($_GET['p'])."'")->row_array();
                if ($_GET['p']=='konsumen'){
                    $sponsore = $ress['id_reseller'];
                    $feexx = 'fee_level';
                }else{
                    $resx = $this->db->query("SELECT id_konsumen FROM rb_reseller WHERE id_reseller='$ress[id_reseller]'")->row_array();
                    $sponsore = $resx['id_konsumen'];
                    $feexx = 'fee_toko_level';
                }
                $total_fee = $ress['tagihan'];
                ...
                do{
                    ...
                    if ($rowx['referral_id']!=''){
                        if ($x==1){
                            if ($_GET['p']=='konsumen'){
                                $fee_rupiah = config($feexx.$x);
                                $fee_persen = config($feexx.$x);
                            }else{
                                $fee_rupiah = config($feexx.$x)/100*$total_fee;
                                $fee_persen = config($feexx.$x);
                            }
                        }else{
                        ...
                        if ($fee_rupiah>0){
                            $data_fee = array('id_rekening_reseller'=>0,
                                    ...
                                    'status'=>'Sukses',
                                    'transaksi'=>'Kredit',
                                    'keterangan'=>"Upgrade Premium Fee",
                                    'akun'=>'konsumen',
            ...
            $datax = array('status'=>$_GET['paket'],
                          'expire_date'=>$tanggal_paket);
            $wherex = array('id_reseller_paket' => $this->input->get('id'),'users'=>cetak($_GET['p']));
            $return = $this->model_app->update('rb_reseller_paket', $datax, $wherex);
            // print_r($this->input->get('id'));
            // if (cetak($_GET['p'])=='toko'){
            //     redirect('administrator/reseller');
            // }else{
            //     redirect('administrator/konsumen');
            // }
            redirect('administrator/reseller_paket');
        }

        if (isset($_GET['mall'])){
            $cek = $this->db->query("UPDATE rb_reseller set hapus_toko='".cetak($_GET['mall'])."' where id_reseller='0'");
            if ($_GET['mall']=='N'){
                echo $this->session->set_flashdata('message', '<div class="alert alert-success alert-dismissible" style="padding:5px; border-left:0px solid"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><center>Tajalapak Mall Berhasil diaktifkan..</center></div>');
            }else{
                echo $this->session->set_flashdata('message', '<div class="alert alert-danger alert-dismissible" style="padding:5px; border-left:0px solid"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><center>Tajalapak Mall telah Non-aktif..</center></div>');
            }
            redirect('administrator/reseller');
        }
    ...
    function edit_reseller(){
        ...
        if (isset($_POST['submit'])){
            ...
            redirect('administrator/detail_reseller/'.$this->input->post('id'));
        }else{
    ...
    function detail_reseller(){
        ...
        if (isset($_POST['submit'])){
            $data = array('id_reseller'=>$id,
                            'nama_alamat'=>$this->input->post('a'),
                            'biaya_cod'=>$this->input->post('b'));
            $this->model_app->insert('rb_reseller_cod',$data);
            redirect('administrator/detail_reseller/'.$id);
        }
        
        if (isset($_GET['del'])){
            $id = array('id_cod' => $_GET['del']);
            $this->model_app->delete('rb_reseller_cod',$id);
            redirect('administrator/detail_reseller/'.$this->uri->segment(3));
        }
    ...
    function tambah_kategori_produk(){
        cek_session_akses('kategori_produk',$this->session->id_session);
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/foto_produk/kategori/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG|jpeg|webp|WEBP';
            $config['max_size'] = '5000'; // kb
            $this->load->library('upload', $config);
        ...
        if (isset($_POST['submit'])){
            ...
            if (trim($fileName)!=''){
                $data = array('id_reseller'=>$this->input->post('id_reseller'),
                              ...
                              'harga_platform'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_platform'))*simpan_rupiah($this->input->post('f'))/100),
                              'harga_platform_persen'=>simpan_rupiah($this->input->post('harga_platform')),
                              'harga_level_newbie'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_level_newbie'))*simpan_rupiah($this->input->post('f'))/100),
                              'harga_level_newbie_persen'=>simpan_rupiah($this->input->post('harga_level_newbie')),
                              'harga_level_pedagang'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_level_pedagang'))*simpan_rupiah($this->input->post('f'))/100),
                              'harga_level_pedagang_persen'=>simpan_rupiah($this->input->post('harga_level_pedagang')),
                              'harga_level_juragan'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_level_juragan'))*simpan_rupiah($this->input->post('f'))/100),
                              'harga_level_juragan_persen'=>simpan_rupiah($this->input->post('harga_level_juragan')),
                              'harga_level_big'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_level_big'))*simpan_rupiah($this->input->post('f'))/100),
                              'harga_level_big_persen'=>simpan_rupiah($this->input->post('harga_level_big')),
                              'harga_level_bos'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_level_bos'))*simpan_rupiah($this->input->post('f'))/100),
                              'harga_level_bos_persen'=>simpan_rupiah($this->input->post('harga_level_bos')),
                              'harga_rekomen_dropship'=>simpan_rupiah($this->input->post('harga_rekomen_dropship')),
                              ...
                              'admin_persen'=>$this->input->post('admin_persen'),
                              'deviden_persen'=>$this->input->post('deviden_persen'),
            ...
            if ($this->input->post('variasi1')!=''){
			    ...
			    $harga_potongan_newbie = array();
			    $harga_potongan_pedagang = array();
			    $harga_potongan_juragan = array();
			    $harga_potongan_big = array();
			    $harga_potongan_bos = array();
			    while ($i < count($this->input->post('hargaa'))) {
                    array_push($harga_potongan_platform, $this->input->post('hargaa')[$i]-(($this->input->post('hargaa')[$i]*$this->input->post('harga_platform'))/100));
                    array_push($harga_potongan_newbie, $this->input->post('hargaa')[$i]-(($this->input->post('hargaa')[$i]*$this->input->post('harga_level_newbie'))/100));
                    array_push($harga_potongan_pedagang, $this->input->post('hargaa')[$i]-(($this->input->post('hargaa')[$i]*$this->input->post('harga_level_pedagang'))/100));
                    array_push($harga_potongan_juragan, $this->input->post('hargaa')[$i]-(($this->input->post('hargaa')[$i]*$this->input->post('harga_level_juragan'))/100));
                    array_push($harga_potongan_big, $this->input->post('hargaa')[$i]-(($this->input->post('hargaa')[$i]*$this->input->post('harga_level_big'))/100));
                    array_push($harga_potongan_bos, $this->input->post('hargaa')[$i]-(($this->input->post('hargaa')[$i]*$this->input->post('harga_level_bos'))/100));
                    $i++;
                }
                ...
                $warna = array('id_produk'=>$id_produk,
                                ...
                                'harga_level_newbie'=>simpan_rupiah(implode(";",$harga_potongan_newbie)),
                                'harga_level_pedagang'=>simpan_rupiah(implode(";",$harga_potongan_pedagang)),
                                'harga_level_juragan'=>simpan_rupiah(implode(";",$harga_potongan_juragan)),
                                'harga_level_big'=>simpan_rupiah(implode(";",$harga_potongan_big)),
                                'harga_level_bos'=>simpan_rupiah(implode(";",$harga_potongan_bos)),
                                'harga_platform_persen'=>simpan_rupiah(implode(";",$this->input->post('harga_platform'))),
                                'harga_level_newbie_persen'=>simpan_rupiah(implode(";",$this->input->post('harga_level_newbie'))),
                                'harga_level_pedagang_persen'=>simpan_rupiah(implode(";",$this->input->post('harga_level_pedagang'))),
                                'harga_level_juragan_persen'=>simpan_rupiah(implode(";",$this->input->post('harga_level_juragan'))),
                                'harga_level_big_persen'=>simpan_rupiah(implode(";",$this->input->post('harga_level_big'))),
                                'harga_level_bos_persen'=>simpan_rupiah(implode(";",$this->input->post('harga_level_bos'))),
                            );
            ...
            if ($this->input->post('variasi2')!=''){
			    ...
			    while ($i < count($this->input->post('hargab'))) {
                    array_push($harga_potongan_platform, $this->input->post('hargab')[$i]-(($this->input->post('hargab')[$i]*$this->input->post('harga_platform'))/100));
                    array_push($harga_potongan_newbie, $this->input->post('hargab')[$i]-(($this->input->post('hargab')[$i]*$this->input->post('harga_level_newbie'))/100));
                    array_push($harga_potongan_pedagang, $this->input->post('hargab')[$i]-(($this->input->post('hargab')[$i]*$this->input->post('harga_level_pedagang'))/100));
                    array_push($harga_potongan_juragan, $this->input->post('hargab')[$i]-(($this->input->post('hargab')[$i]*$this->input->post('harga_level_juragan'))/100));
                    array_push($harga_potongan_big, $this->input->post('hargab')[$i]-(($this->input->post('hargab')[$i]*$this->input->post('harga_level_big'))/100));
                    array_push($harga_potongan_bos, $this->input->post('hargab')[$i]-(($this->input->post('hargab')[$i]*$this->input->post('harga_level_bos'))/100));
                    $i++;
                }
            ...
            if ($this->input->post('variasi3')!=''){
			    ...
			    while ($i < count($this->input->post('hargac'))) {
                    array_push($harga_potongan_platform, $this->input->post('hargac')[$i]-(($this->input->post('hargac')[$i]*$this->input->post('harga_platform'))/100));
                    array_push($harga_potongan_newbie, $this->input->post('hargac')[$i]-(($this->input->post('hargac')[$i]*$this->input->post('harga_level_newbie'))/100));
                    array_push($harga_potongan_pedagang, $this->input->post('hargac')[$i]-(($this->input->post('hargac')[$i]*$this->input->post('harga_level_pedagang'))/100));
                    array_push($harga_potongan_juragan, $this->input->post('hargac')[$i]-(($this->input->post('hargac')[$i]*$this->input->post('harga_level_juragan'))/100));
                    array_push($harga_potongan_big, $this->input->post('hargac')[$i]-(($this->input->post('hargac')[$i]*$this->input->post('harga_level_big'))/100));
                    array_push($harga_potongan_bos, $this->input->post('hargac')[$i]-(($this->input->post('hargac')[$i]*$this->input->post('harga_level_bos'))/100));
                    $i++;
                }
        ...
        if (isset($_POST['submit'])){
            ...
            if (trim($fileName)!=''){
                $data = array('id_reseller'=>$this->input->post('id_reseller'),
                              ...
                              'harga_reseller'=>simpan_rupiah($this->input->post('e')),
                              'harga_konsumen'=>simpan_rupiah($this->input->post('f')),
                              'harga_platform'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_platform'))*simpan_rupiah($this->input->post('f'))/100)),
                              'harga_platform_persen'=>simpan_rupiah($this->input->post('harga_platform')),
                              'harga_level_newbie'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_level_newbie'))*simpan_rupiah($this->input->post('f'))/100),
                              'harga_level_newbie_persen'=>simpan_rupiah($this->input->post('harga_level_newbie')),
                              'harga_level_pedagang'=>simpan_rupiah($this->input->post('f'))-(simpan_rupiah($this->input->post('harga_level_pedagang'))*simpan_rupiah($this->input->post('f'))/100),
                              ...
                              'keterangan'=>$this->input->post('ff'),
                              'aktif'=>$this->input->post('aktif'),
                              'revisi_feedback'=>$this->input->post('catatan_revisi'),
                              'tag'=>$tag,
                              'fee_produk'=>$this->input->post('fee_produk'),
                              'pre_order'=>$pre_order,
                              'jenis_produk'=>$this->input->post('jenis_produk'),
			...
			if ($this->input->post('variasix1')!=''){
			    ...
			    while ($i < count($this->input->post('hargaa1'))) {
                    array_push($harga_potongan_platform, $this->input->post('hargaa1')[$i]-(($this->input->post('hargaa1')[$i]*$this->input->post('harga_platform'))/100));
                    array_push($harga_potongan_newbie, $this->input->post('hargaa1')[$i]-(($this->input->post('hargaa1')[$i]*$this->input->post('harga_level_newbie'))/100));
                    array_push($harga_potongan_pedagang, $this->input->post('hargaa1')[$i]-(($this->input->post('hargaa1')[$i]*$this->input->post('harga_level_pedagang'))/100));
                    array_push($harga_potongan_juragan, $this->input->post('hargaa1')[$i]-(($this->input->post('hargaa1')[$i]*$this->input->post('harga_level_juragan'))/100));
                    array_push($harga_potongan_big, $this->input->post('hargaa1')[$i]-(($this->input->post('hargaa1')[$i]*$this->input->post('harga_level_big'))/100));
                    array_push($harga_potongan_bos, $this->input->post('hargaa1')[$i]-(($this->input->post('hargaa1')[$i]*$this->input->post('harga_level_bos'))/100));
                    $i++;
                }
			...
			if ($this->input->post('variasix2')!=''){
			    ...
			    while ($i < count($this->input->post('hargab2'))) {
                    array_push($harga_potongan_platform, $this->input->post('hargab2')[$i]-(($this->input->post('hargab2')[$i]*$this->input->post('harga_platform'))/100));
                    array_push($harga_potongan_newbie, $this->input->post('hargab2')[$i]-(($this->input->post('hargab2')[$i]*$this->input->post('harga_level_newbie'))/100));
                    array_push($harga_potongan_pedagang, $this->input->post('hargab2')[$i]-(($this->input->post('hargab2')[$i]*$this->input->post('harga_level_pedagang'))/100));
                    array_push($harga_potongan_juragan, $this->input->post('hargab2')[$i]-(($this->input->post('hargab2')[$i]*$this->input->post('harga_level_juragan'))/100));
                    array_push($harga_potongan_big, $this->input->post('hargab2')[$i]-(($this->input->post('hargab2')[$i]*$this->input->post('harga_level_big'))/100));
                    array_push($harga_potongan_bos, $this->input->post('hargab2')[$i]-(($this->input->post('hargab2')[$i]*$this->input->post('harga_level_bos'))/100));
                    $i++;
                }
			...
			if ($this->input->post('variasix3')!=''){
			    ...
			    while ($i < count($this->input->post('hargac3'))) {
                    array_push($harga_potongan_platform, $this->input->post('hargac3')[$i]-(($this->input->post('hargac3')[$i]*$this->input->post('harga_platform'))/100));
                    array_push($harga_potongan_newbie, $this->input->post('hargac3')[$i]-(($this->input->post('hargac3')[$i]*$this->input->post('harga_level_newbie'))/100));
                    array_push($harga_potongan_pedagang, $this->input->post('hargac3')[$i]-(($this->input->post('hargac3')[$i]*$this->input->post('harga_level_pedagang'))/100));
                    array_push($harga_potongan_juragan, $this->input->post('hargac3')[$i]-(($this->input->post('hargac3')[$i]*$this->input->post('harga_level_juragan'))/100));
                    array_push($harga_potongan_big, $this->input->post('hargac3')[$i]-(($this->input->post('hargac3')[$i]*$this->input->post('harga_level_big'))/100));
                    array_push($harga_potongan_bos, $this->input->post('hargac3')[$i]-(($this->input->post('hargac3')[$i]*$this->input->post('harga_level_bos'))/100));
                    $i++;
                }
			...
			if (simpan_rupiah(cetak($this->input->post('diskon'))) > 0){
            	$cek = $this->db->query("SELECT * FROM rb_produk_diskon where id_produk='".$this->input->post('id')."'");
				if ($cek->num_rows()>=1){
					$data = array('diskon'=>simpan_rupiah(cetak($this->input->post('diskon'))));
					$where = array('id_produk' => cetak($this->input->post('id')));
					$this->model_app->update('rb_produk_diskon', $data, $where);
				}else{
					$data = array('id_produk'=>cetak($this->input->post('id')),
			                      'id_reseller'=>cetak($this->input->post('id_reseller')),
			    ...
			    $idx = array('id_produk' => cetak($this->input->post('id')),'id_reseller'=>cetak($this->input->post('id_reseller')));
                $this->model_app->delete('rb_produk_diskon',$idx);
			}
...
public function upload(){
    ...
    if(isset($_FILES['uploadFile'])){
        ...
        $config['allowed_types'] = 'jpg|jpeg|png|txt|pdf|gif|zip|rar|tar|webp|WEBP';
...
public function uploadx(){
    ...
    private function set_upload_options(){
        $config = array();
        $config['upload_path'] = 'asset/foto_produk/';
        $config['allowed_types'] = 'gif|jpg|png|jpeg|JPG|JPEG|PNG|GIF|webp|WEBP';
    ...
    function tambah_withdraw(){
        ...
        if (isset($_POST['submit'])){
			if (cetak($this->input->post('jenis'))=='debit'){
			...
			}elseif (cetak($this->input->post('jenis'))=='debitx'){
				$nominal = clean_rupiah(cetak($this->input->post('b')));
                $data = array('id_rekening_reseller'=>0,
                            ...
                            'akun'=>'konsumen',
                            'transaksi'=>'debit',
                            'keterangan'=>"Saldo Dipotong",
                            'waktu_withdraw'=>date('Y-m-d H:i:s'));
                        $this->model_app->insert('rb_withdraw',$data);

                if ($this->input->post('bagikan')=='ya'){
                    $x=1; 
                    $level = 5;
                    $sponsore = cetak($this->input->post('id_reseller'));
                    $total_fee = $nominal;
                        ...
                        if ($rowx['referral_id']!=''){
                            ...
                            if ($fee_rupiah>0){
                                $data_fee = array('id_rekening_reseller'=>0,
                                        ...
                                        'status'=>'Sukses',
                                        'transaksi'=>'Kredit',
                                        'keterangan'=>"Komisi Debit $fee_persen%",
                                        'akun'=>'konsumen',
                                        'waktu_withdraw'=>date('Y-m-d H:i:s'));
                                $this->model_app->insert('rb_withdraw',$data_fee);
                            }
    ...
    function proses_withdraw(){
        ...
        if ($this->uri->segment(4)=='Sukses'){
            ...
            $isi_pesan = "*$iden[pengirim_email]* - Haloo Bpk/Ibk. *$nama*, Permintaan anda untuk $request Rp ".rupiah($cek['nominal'])." - ".rupiah($cek['withdraw_fee'])." ($request Fee) = *".rupiah($cek['nominal']-$cek['withdraw_fee'])."* Sukses Diproses,..";
    ...
    function tambah_rekening(){
        ...
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/images/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG|swf|webp|WEBP';
            $config['max_size'] = '5000'; // kb
            $this->load->library('upload', $config);
            $this->upload->do_upload('gambar');
            $hasil=$this->upload->data();
    ...
    if (isset($_GET['batal'])){
        ...
        $data_payment = array('proses'=>'x');
        $this->model_app->update('rb_penjualan', $data_payment, $id);
    ...
    function ppob_ty35fgdfgd777bba064b72be(){
        $secret = '3RKHRKu0jPPehKEDauu5zSQKYKTEWP5q';
    ...
    function ppob(){
        cek_session_akses('ppob',$this->session->id_session);
        $data['record'] = $this->model_app->view_ordering('rb_ppob','id_ppob','ASC');
        $this->template->load('administrator/template','administrator/additional/mod_ppob/view_ppob',$data);
    }
    ...
    function edit_ppob(){
        ...
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/images/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG|jpeg|svg|webp|WEBP';
            $config['max_size'] = '5000'; // kb
            $this->load->library('upload', $config);
            $this->upload->do_upload('icon_image');
            $hasil=$this->upload->data();
            ...
            if ($hasil['file_name']==''){
                $data = array('nama_ppob'=>$this->input->post('nama_ppob'),
                                'icon_kode'=>$this->input->post('icon_kode'),
                                'aktif'=>$this->input->post('aktif'));
            }else{
                $data = array('nama_ppob'=>$this->input->post('nama_ppob'),
                                'icon_kode'=>$this->input->post('icon_kode'),
                                'icon_image'=>$hasil['file_name'],
                                'aktif'=>$this->input->post('aktif'));
            }
            $where = array('id_ppob' => $this->input->post('id'));
            $this->model_app->update('rb_ppob', $data, $where);
            redirect('administrator/ppob');
        }else{
            $data['rows'] = $this->model_app->edit('rb_ppob',array('id_ppob'=>$id))->row_array();
            $this->template->load('administrator/template','administrator/additional/mod_ppob/view_ppob_edit',$data);
        }
    }
    ...
    function format_data(){
        ...
        if (isset($_GET['hide'])){
            ...
            $this->db->query("TRUNCATE TABLE rb_reseller_operasional");
            ...
            $this->db->query("DELETE FROM rb_reseller where id_reseller!='0'");
            $this->db->query("ALTER TABLE rb_reseller AUTO_INCREMENT=0");
    ...
    // Controller Modul Notifikasi

    function notifikasi(){
        cek_session_akses('notifikasi',$this->session->id_session);
        $data['record'] = $this->model_app->view_ordering('rb_notifikasi','id_notifikasi','DESC');
        $this->template->load('administrator/template','administrator/additional/mod_notifikasi/view',$data);
    }
    ...
    function tambah_notifikasi(){
        ...
        if (isset($_POST['submit'])){
            ...
            $this->model_app->insert('rb_notifikasi',$data);  
            $id_notifikasi = $this->db->insert_id();

            if ($this->input->post('kategori')=='all'){
                $konsumen = $this->db->query("SELECT * FROM rb_konsumen");
                foreach ($konsumen->result_array() as $row) {
                    $data_send = array('id_notifikasi'=>$id_notifikasi,
                        'id_konsumen'=>$row['id_konsumen'],
                        'waktu_kirim'=>date('Y-m-d H:i:s'));
                    $this->model_app->insert('rb_notifikasi_send',$data_send);  
                }
            }

            redirect($this->uri->segment(1).'/notifikasi');
        }else{
            $this->template->load('administrator/template','administrator/additional/mod_notifikasi/tambah');
        }
    }

    function delete_notifikasi(){
        cek_session_akses('notifikasi',$this->session->id_session);
        $id = array('id_notifikasi' => $this->uri->segment(3));
        $this->model_app->delete('rb_notifikasi_send',$id);
        $this->model_app->delete('rb_notifikasi',$id);
        redirect($this->uri->segment(1).'/notifikasi');
    }
...
// 	Link Batrisyia
	function link_batrisyia(){
        cek_session_akses('imagesslider',$this->session->id_session);
		$data['record'] = $this->model_app->batrisyia_link();
		$this->template->load('administrator/template','administrator/mod_link_batrisyia/view_slider',$data);
	}

	function tambah_link_batrisyia(){
		cek_session_akses('imagesslider',$this->session->id_session);
		if (isset($_POST['submit'])){
			$this->model_app->batrisyia_link_tambah();
			redirect($this->uri->segment(1).'/link_batrisyia');
		}else{
			$this->template->load('administrator/template','administrator/mod_link_batrisyia/view_slider_tambah');
		}
	}

	function edit_link_batrisyia(){
		cek_session_akses('imagesslider',$this->session->id_session);
		$id = $this->uri->segment(3);
		if (isset($_POST['submit'])){
			$this->model_app->batrisyia_link_update();
			redirect($this->uri->segment(1).'/link_batrisyia');
		}else{
			$data['rows'] = $this->model_app->batrisyia_link_edit($id)->row_array();
			$this->template->load('administrator/template','administrator/mod_link_batrisyia/view_slider_edit',$data);
		}
	}

	function delete_link_batrisyia(){
        cek_session_akses('imagesslider',$this->session->id_session);
		$id = $this->uri->segment(3);
		$this->model_app->batrisyia_link_delete($id);
		redirect($this->uri->segment(1).'/link_batrisyia');
    }
}
